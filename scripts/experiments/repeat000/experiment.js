{
	...
	"RunSimpleModel": {
		...
		"stdout": "output",
		"stderr": "output",
		"depends": ["SampleTestData", "CreateSimpleModel"],
		"array": [1, 100],
		"cmd": ["pypy-env/bin/pypy",
			"bin/Realign.py",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.fa",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.simpleModel.fa",
	...
	"RunViterbi": {
		...
		"stdout": "output",
		"stderr": "output",
		"depends": ["SampleTestData", "RunRepeatRealigner"],
		"array": [1, 100],
		"cmd": ["pypy-env/bin/pypy",
			"bin/Realign.py",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.fa",
	...
	"RunViterbiSimpleModel": {
		...
		"cmd": ["pypy-env/bin/pypy",
			"bin/Realign.py",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.fa",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.simpleModelViterbi.fa",
			"--model data/experiments/repeat0001/original_simple_model.js",
			"--mathType LogNum",
			"--beam_width 30",
			"--sequence_regexp 'sequence1' 'sequence2'",
	...
	"RunRepeatRealignerV2": {
		...
		"cmd": ["pypy-env/bin/pypy",
			"bin/Realign.py",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.fa",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.repeatRealignerV2.fa",
			"--model data/experiments/repeat0001/original_model.js",
			"--mathType LogNum",
			"--beam_width 30",
			"--repeat_width 0",
		...
		"cmd": ["pypy-env/bin/pypy",
			"bin/Realign.py",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.fa",
			"data/experiments/repeat0001/sampled_test_aln/aln_{id}.repeatRealignerOriginalV2.fa",
			"--model data/experiments/repeat0001/original_model.js",
			"--mathType LogNum",
			"--beam_width 30",
			"--repeat_width 0",
	...
	"RunRepeatRealignerLotOfRepeats": {
        ...
        "EvaluateExperiment": {
                ...
                "stdout": "output",
                "stderr": "output",
                "depends": ["RunRepeatRealigner", "RunSimpleModel", "RunRepeatRealignerOriginalRepeats", "RunViterbi", "RunViterbiSimpleModel", "RunViterbiOriginalRepeats", "RunContext", "RunRepeatRealignerV2", "RunRepeatRealignerOriginalRepeatsV2", "RunRepeatRealignerLotOfRepeats"],
                "cmd": ["pypy-env/bin/pypy",
