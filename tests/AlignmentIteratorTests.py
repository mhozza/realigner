from AlignmentIterator import TextAlignmentToTupleList, AlignmentPositionGenerator, AlignmentBeamGenerator
import unittest

class AlignmentIteratorTest(unittest.TestCase):
    
    def setUp(self):
        self.Alignment = TextAlignmentToTupleList("ACG--C-A--CA-C", "AC-TGGGAC-CACC")
        return
    ...
    def test_tupleList(self):
        ...
        for test in tests:
            ...
            Y = test[2]
            self.assertEqual(X, Y, "Wrong conversion to tuple list: "+str(X)+" != "+str(Y))
            
    def test_positions(self):
        X = [(0, 0), (1, 1), (2, 1), (2, 2), (2, 3), (3, 4), (3, 5), (4, 6), (4, 7), (4, 7), (5, 8), (6, 9), (6, 10), (7, 11)]
        Y = list(AlignmentPositionGenerator(self.Alignment))
        self.assertEqual(X, Y, "Position generator does not work: " + str(X) + " != " + str(Y))
    
    def test_beam(self):
        self.assertEqual(self.Alignment,TextAlignmentToTupleList("ACG--C-A--CA-C", "AC-TGGGAC-CACC"))
